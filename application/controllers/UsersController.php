...
class UsersController extends \Phalcon\Mvc\Controller {
    ...
    public function createAction() {
        if ($this->request->isPost('frmLogin')) {
            $user = new User();
            //Assign the values to the object (No constructorarguments?? Stupid but true.):
    ...
    public function loginAction() {
        if ($this->request->isPost()) {
            ...
            //Prepare statements are used, so that no SQL-injection may happen.
